  ...
  return (
    ...
    >
      ...
      <span className={cn(
        ...
        "text-2xl lg:text-4xl",   // Tamanho grande para dar o destaque
        "ml-0 md:-ml-4 -mb-2 md:-mb-3", // Ajuste fino de posicionamento (overlap)
      ...
      <div className={cn(
        ...
        "text-3xl lg:text-4xl leading-tight", // Tamanho robusto
        "transition-colors duration-500",
        light ? "text-garden-text" : "text-garden-dark"
      )}>
        <span className="block">Garden</span>
        <span className="block -mt-1.25">Brows</span>
      </div>
    </Link>
  );
}