...
export const metadata = {
  ...
  description:
    "Conheça a trajetória de Carol Garden, sua filosofia de beleza e devoção.",
};
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32">
          <div className="relative aspect-portrait overflow-hidden rounded-t-full border border-garden-text/10">
            <Image
              src="/carol-garden.webp" // Foto da Carolina
          ...
          <div className="flex flex-col gap-8">
            ...
            <p className="font-sans text-base text-garden-text/60 leading-relaxed font-light">
              Expert em design de sobrancelhas, Lash Lift, Brow Lamination e
              Micropigmentação Labial,
              <span className="font-bold"> Carol Garden</span> transformou sua
              paixão pela estética em um ministério de cuidado. Casada e mãe da
              Mariana (nosso anjinho no céu) e da pequena Catarina, ela imprime
              em cada atendimento o amor e a dedicação que transbordam de sua fé
              católica.
            </p>

            <p className="font-sans text-base text-garden-text/50 leading-relaxed font-light">
              No Studio Garden Brows, o trabalho das mãos é guiado pela devoção.
              Buscamos realçar a beleza que Deus já depositou em cada mulher,
              com a delicadeza e a perfeição de quem entende que o autocuidado é
              também uma forma de gratidão.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-y border-garden-text/5 py-16">
          {[
            ...
            <div key={skill} className="text-center">
              <span className="font-serif italic text-lg text-garden-text/40 block mb-2 opacity-50">
                ✓
              </span>
              <p className="font-sans text-[10px] uppercase tracking-[0.2em] text-garden-text/60">
                {skill}
              </p>
            </div>
          ))}
